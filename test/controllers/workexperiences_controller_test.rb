...
class WorkexperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workexperience" do
    assert_difference("Workexperience.count") do
      post workexperiences_url, params: { workexperience: { about: @workexperience.about, company: @workexperience.company, designation: @workexperience.designation, enddate: @workexperience.enddate, startdate: @workexperience.startdate } }
    end
  ...
  test "should update workexperience" do
    patch workexperience_url(@workexperience), params: { workexperience: { about: @workexperience.about, company: @workexperience.company, designation: @workexperience.designation, enddate: @workexperience.enddate, startdate: @workexperience.startdate } }
